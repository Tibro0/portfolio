                ...
                <div class="col-lg-6 hero-content" data-aos="fade-right" data-aos-delay="100">
                    <div class="content-wrapper">
                        <h1 class="hero-title">
                            I'm a
                            <span class="typed"
                                data-typed-items="Web Designer, Laravel Developer, PHP Developer, Web Developer"></span>
                        </h1>
                        <p class="lead">
            ...
            <div class="row align-items-center">
                <div class="col-lg-5" data-aos="fade-right" data-aos-delay="200">
                    <div class="profile-image-wrapper">
                        <div class="profile-image">
                            <img src="{{ asset('frontend/assets/img/profile/profile-square-1.webp') }}" alt="Profile"
                                class="img-fluid" />
                        </div>
                        <div class="signature-section">
                            <img src="{{ asset('frontend/assets/img/misc/signature-1.webp') }}" alt="Signature"
                                class="signature" />
                            <p class="quote">
                                Building meaningful digital experiences through creative
                                code.
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-lg-7" data-aos="fade-left" data-aos-delay="300">
                    <div class="about-content">
                        <div class="intro">
                            <h2>Hi, I'm MD. Faysal Hossain Tibro</h2>
                            <p>
                            ...
                            <div class="experience-card" data-aos="zoom-in" data-aos-delay="300">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="achievements">
                                        ...
                                        <li>
                                            Implemented agile methodologies resulting in 40%
                                            efficiency gain
                                        </li>
                                        <li>
            ...
            <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
                ...
                <div class="row g-4 isotope-container" data-aos="fade-up" data-aos-delay="300">
                    <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-ui">
                        <article class="portfolio-entry">
                            <figure class="entry-image">
                                <img src="{{ asset('frontend/assets/img/portfolio/portfolio-1.webp') }}" class="img-fluid"
                                    alt="" loading="lazy" />
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-ui">
                        <article class="portfolio-entry">
                            <figure class="entry-image">
                                <img src="{{ asset('frontend/assets/img/portfolio/portfolio-2.webp') }}" class="img-fluid"
                                    alt="" loading="lazy" />
                                <div class="entry-overlay">
                                    <div class="overlay-content">
                                        <div class="entry-meta">UI/UX Design</div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-profile">
                                            <img src="{{ asset('frontend/assets/img/person/person-f-1.webp') }}"
                                                alt="Reviewer" class="img-fluid rounded-circle" />
                                            <div>
                                                <h3>Jane Smith</h3>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-profile">
                                            <img src="{{ asset('frontend/assets/img/person/person-m-2.webp') }}"
                                                alt="Reviewer" class="img-fluid rounded-circle" />
                                            <div>

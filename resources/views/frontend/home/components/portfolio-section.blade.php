                                ...
                                <div class="entry-overlay">
                                    <div class="overlay-content">
                                        ...
                                        <div class="entry-links">
                                            <a href="{{asset('frontend/assets/img/portfolio/portfolio-1.webp')}}" class="glightbox"
                            ...
                            <figure class="entry-image">
                                ...
                                <div class="entry-overlay">
                                    <div class="overlay-content">
                                        ...
                                        <div class="entry-links">
                                            <a href="{{asset('frontend/assets/img/portfolio/portfolio-10.webp')}}" class="glightbox"
                            ...
                            <figure class="entry-image">
                                ...
                                <div class="entry-overlay">
                                    <div class="overlay-content">
                                        ...
                                        <div class="entry-links">
                                            <a href="{{asset('frontend/assets/img/portfolio/portfolio-4.webp')}}" class="glightbox"
                            ...
                            <figure class="entry-image">
                                ...
                                <div class="entry-overlay">
                                    <div class="overlay-content">
                                        ...
                                        <div class="entry-links">
                                            <a href="{{asset('frontend/assets/img/portfolio/portfolio-2.webp')}}" class="glightbox"
                                                data-gallery="portfolio-gallery-ui"
                            ...
                            <figure class="entry-image">
                                ...
                                <div class="entry-overlay">
                                    <div class="overlay-content">
                                        ...
                                        <div class="entry-links">
                                            <a href="{{asset('frontend/assets/img/portfolio/portfolio-8.webp')}}" class="glightbox"
                            ...
                            <figure class="entry-image">
                                ...
                                <div class="entry-overlay">
                                    <div class="overlay-content">
                                        ...
                                        <div class="entry-links">
                                            <a href="{{asset('frontend/assets/img/portfolio/portfolio-5.webp')}}" class="glightbox"
                                                data-gallery="portfolio-gallery-marketing"

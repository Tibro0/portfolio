...
class SectionTitleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        SectionTitle::insert([
            ...
            [
                'key' => 'resume_main_title',
                'value' => 'Resume',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'key' => 'resume_sub_title',
                'value' => 'Tech leader driving innovation & growth through transformative execution.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
            ...
            [
                ...
                'value' => 'Crafting innovative digital solutions that drive growth and user engagement.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'key' => 'portfolio_main_title',
                'value' => 'Portfolio',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'key' => 'portfolio_sub_title',
                'value' => 'Innovative tech solutions delivered through strategic leadership and relentless execution.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
            ...
            [
                ...
                'value' => 'Results-driven innovator building high-performing teams and transformative products.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ]);
